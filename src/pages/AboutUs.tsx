...
const timelineEvents = [
  { year: 1990, event: 'Debbie O\'Brien begins her career in real estate' },
  { year: 2005, event: 'Transition to transaction coordination' },
  { year: 2015, event: 'Founded PA Real Estate Support Services, LLC' },
  { year: 2023, event: 'Expanded services to cover the entire Pocono Mountains region' }
];
